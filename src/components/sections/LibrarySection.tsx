...
const LibrarySection: React.FC<LibrarySectionProps> = ({ section }) => {
  ...
  const defaultBooks = [
    { title: 'The Great Gatsby', author: 'F. Scott Fitzgerald', cover: 'https://via.placeholder.com/200x250' },
    { title: 'To Kill a Mockingbird', author: 'Harper Lee', cover: 'https://via.placeholder.com/200x250' },
    { title: '1984', author: 'George Orwell', cover: 'https://via.placeholder.com/200x250' },
    { title: 'Pride and Prejudice', author: 'Jane Austen', cover: 'https://via.placeholder.com/200x250' },
  ];
